      ...
      <aside style={{ width: sidebarOpen ? 220 : 48, transition: 'width 0.2s', flexShrink: 0 }}
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '8px 0' }}>
          ...
          {project.members.map(m => (
            ...
            >
              <span style={{ fontSize: 11, fontWeight: 700, flexShrink: 0, color: m.memberType === 'column' ? '#c084fc' : m.memberType === 'wall' ? '#4ade80' : '#60a5fa' }}>
                {m.id}
              </span>
              {sidebarOpen && (
        ...
        {sidebarOpen && (
          <div style={{ padding: '12px', borderTop: '1px solid #1e293b' }}>
            {[['Beam', '#60a5fa'], ['Column', '#c084fc'], ['Wall', '#4ade80']].map(([t, c]) => (
            ...
            <div>
              <div style={{ marginBottom: 12 }}>
                ...
                <p style={{ fontSize: 11, color: '#64748b', margin: '4px 0 0' }}>
                  ...
                  {activeMember.section.type === 'circular_column'
                    ? `Ø${activeMember.section.diameter}"`
